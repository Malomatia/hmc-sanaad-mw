...
const COLUMNS: Readonly<Record<string, ColumnContract>> = Object.freeze({
  ...
  [ORACLE_OBJECTS.ALSR_DFALT_LOV]: { DEFAULT_VALUE: 'VARCHAR2', DEFAULT_VALUE_AR: 'VARCHAR2' },
  [ORACLE_OBJECTS.LIBR_DFALT_LOV]: { DEFAULT_VALUE: 'VARCHAR2', DEFAULT_VALUE_AR: 'VARCHAR2' },
